...
## Project Structure
    ...
    ├── buscaprofissionais_34719  # Django project configurations
...
1. Clone this repo and `cd buscaprofissionais_34719`
...
2. Clone this repo and `cd buscaprofissionais_34719`
